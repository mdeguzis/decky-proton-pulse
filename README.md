...
Proton Pulse supports 29 languages. Translation coverage is measured during build and can be enforced with `pnpm run check-translations` (90% minimum).

| Language | Code | Coverage | Status |
|---|---|---|---|
| English | en | 100.0% (canonical) | canonical |
| Deutsch | de | 90.4% | pass |
| Español | es | 90.4% | pass |
| Français | fr | 90.4% | pass |
| Italiano | it | 90.4% | pass |
| 日本語 | ja | 90.4% | pass |
| 한국어 | ko | 90.4% | pass |
| Nederlands | nl | 90.4% | pass |
| Polski | pl | 90.4% | pass |
| Português (BR) | pt-BR | 90.4% | pass |
| Русский | ru | 90.4% | pass |
| Türkçe | tr | 90.4% | pass |
| Українська | uk | 90.4% | pass |
| Svenska | sv | 90.4% | pass |
| Čeština | cs | 90.4% | pass |
| ภาษาไทย | th | 90.4% | pass |
| Tiếng Việt | vi | 90.4% | pass |
| 简体中文 | zh-CN | 90.4% | pass |
| 繁體中文 | zh-TW | 90.4% | pass |
| Български | bg | 90.4% | pass |
| Dansk | da | 90.4% | pass |
| Ελληνικά | el | 90.4% | pass |
| Español (Latinoamérica) | es-419 | 90.4% | pass |
| Suomi | fi | 90.4% | pass |
| Magyar | hu | 90.4% | pass |
| Norsk | no | 90.4% | pass |
| Português (PT) | pt | 90.4% | pass |
| Română | ro | 90.4% | pass |
| Slovenščina | sl | 90.4% | pass |
