...
const T = {
  ...
  // Added for the 1.13.1 release -- brings translation coverage to 100%.
  pendingApproval: {
    de: 'Ausstehende Genehmigung', es: 'Pendiente de aprobación', fr: "En attente d'approbation",
    it: 'In attesa di approvazione', ja: '承認待ち', ko: '승인 대기', nl: 'In afwachting van goedkeuring',
    pl: 'Oczekuje na zatwierdzenie', 'pt-BR': 'Aguardando aprovação', ru: 'Ожидает подтверждения',
    tr: 'Onay bekliyor', uk: 'Очікує підтвердження', sv: 'Väntar på godkännande',
    cs: 'Čeká na schválení', th: 'รอการอนุมัติ', vi: 'Chờ phê duyệt',
    'zh-CN': '待审批', 'zh-TW': '待審核', bg: 'Изчаква одобрение', da: 'Afventer godkendelse',
    el: 'Εκκρεμεί έγκριση', 'es-419': 'Pendiente de aprobación', fi: 'Odottaa hyväksyntää',
    hu: 'Jóváhagyásra vár', no: 'Venter på godkjenning', pt: 'A aguardar aprovação',
    ro: 'În așteptarea aprobării', sl: 'Čaka odobritev',
  },
  downvote: {
    de: 'Ablehnen', es: 'Voto negativo', fr: 'Voter contre', it: 'Voto negativo',
    ja: '低評価', ko: '반대', nl: 'Afkeuren', pl: 'Głos przeciw',
    'pt-BR': 'Voto negativo', ru: 'Против', tr: 'Aleyhte oy', uk: 'Проти',
    sv: 'Nedröst', cs: 'Hlas proti', th: 'ไม่เห็นด้วย', vi: 'Không đồng ý',
    'zh-CN': '踩', 'zh-TW': '倒讚', bg: 'Против', da: 'Nedstem',
    el: 'Αρνητική ψήφος', 'es-419': 'Voto negativo', fi: 'Alaspäänääni',
    hu: 'Nemleges szavazat', no: 'Nedstem', pt: 'Voto negativo',
    ro: 'Vot negativ', sl: 'Glas proti',
  },
  ownReportNoVote: {
    de: 'Sie können nicht für Ihren eigenen Bericht abstimmen',
    es: 'No puedes votar en tu propio informe',
    fr: 'Vous ne pouvez pas voter sur votre propre rapport',
    it: 'Non puoi votare il tuo report',
    ja: '自分のレポートには投票できません',
    ko: '자신의 보고서에는 투표할 수 없습니다',
    nl: 'Je kunt niet stemmen op je eigen rapport',
    pl: 'Nie możesz głosować na swój własny raport',
    'pt-BR': 'Você não pode votar no seu próprio relatório',
    ru: 'Вы не можете голосовать за свой отчёт',
    tr: 'Kendi raporunuza oy veremezsiniz',
    uk: 'Ви не можете голосувати за власний звіт',
    sv: 'Du kan inte rösta på din egen rapport',
    cs: 'Nemůžete hlasovat pro vlastní hlášení',
    th: 'คุณไม่สามารถโหวตรายงานของตนเองได้',
    vi: 'Bạn không thể bỏ phiếu cho báo cáo của mình',
    'zh-CN': '不能对自己的报告投票',
    'zh-TW': '無法對自己的回報投票',
    bg: 'Не можете да гласувате за собствения си доклад',
    da: 'Du kan ikke stemme på din egen rapport',
    el: 'Δεν μπορείτε να ψηφίσετε τη δική σας αναφορά',
    'es-419': 'No puedes votar en tu propio reporte',
    fi: 'Et voi äänestää omaa raporttiasi',
    hu: 'Nem szavazhat a saját jelentésére',
    no: 'Du kan ikke stemme på din egen rapport',
    pt: 'Não pode votar no seu próprio relatório',
    ro: 'Nu puteți vota propriul raport',
    sl: 'Ne morete glasovati o svojem poročilu',
  },
  releaseNotes: {
    de: 'Versionshinweise', es: 'Notas de la versión', fr: 'Notes de version',
    it: 'Note di rilascio', ja: 'リリースノート', ko: '릴리스 노트',
    nl: 'Release-opmerkingen', pl: 'Informacje o wydaniu', 'pt-BR': 'Notas de lançamento',
    ru: 'Заметки о выпуске', tr: 'Sürüm notları', uk: 'Примітки до випуску',
    sv: 'Versionsanteckningar', cs: 'Poznámky k vydání', th: 'บันทึกการเผยแพร่',
    vi: 'Ghi chú phát hành', 'zh-CN': '发行说明', 'zh-TW': '發行說明',
    bg: 'Бележки към изданието', da: 'Udgivelsesnoter', el: 'Σημειώσεις έκδοσης',
    'es-419': 'Notas de la versión', fi: 'Julkaisutiedot', hu: 'Kiadási megjegyzések',
    no: 'Utgivelsesnotater', pt: 'Notas da versão', ro: 'Note de lansare',
    sl: 'Opombe ob izdaji',
  },
};
