...
export const ru: TranslationTree = {
  ...
  settings: {
    ...
    general: 'Общие',
    gamePageBadge: 'Значок на странице игры',
    gamePageBadgeDescription: 'Показывать значок Proton Pulse на страницах библиотеки игр',
    developerArea: 'Область разработчика',
    developerAreaDescription: 'Инструменты для разработки и тестирования плагина',
    fetchUpdatesFromGitHub: 'Получить обновления с GitHub',
    fetchUpdatesFromGitHubDescription: 'Проверить новые версии плагина на GitHub',
    releaseTagInstall: 'Доступные релизы',
    noReleasesLoaded: 'Нажмите Обновить, чтобы загрузить релизы с GitHub.',
  },
  compatTools: {
    install: 'Установить',
    uninstall: 'Удалить',
