...
export const ru: TranslationTree = {
  ...
  configManager: {
    ...
    customToggleEmpty: 'Сохранённых пользовательских тумблеров пока нет.',
    customToggleValidation: 'Перед сохранением заполните название, переменную окружения и значение.',
    customToggleSaved: 'Пользовательские тумблеры обновлены.',
    customToggleEditing: 'Редактирование пользовательского тумблера',
    customToggleDisabledHint: 'Сохранённые пользовательские тумблеры по умолчанию выключены. Включайте их в разделе Custom, когда захотите использовать.',
    previewHint: 'Переключайте опции ниже для настройки команды запуска. Разделы предварительно отфильтрованы по вашему оборудованию. Разверните любой раздел, чтобы применить тумблеры.',
