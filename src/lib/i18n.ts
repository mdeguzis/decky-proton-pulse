...
export interface TranslationTree {
  ...
  extras?: {
    ...
    reportFormVersionPickerPlaceholder?: () => string;
    reportFormPlayModeSection?: () => string;
    reportFormPlayModeLabel?: () => string;
    reportFormPlayModeFlat?: () => string;
    reportFormPlayModeVr?: () => string;
    reportFormPlayModeAutoVrOnly?: () => string;
    reportFormPlayModeAutoVrSupported?: () => string;
    reportFormVrRuntimeLabel?: () => string;
    reportFormVrHeadsetLabel?: () => string;
    reportFormVrHeadsetNotSpecified?: () => string;
    reportFormVrHeadsetOther?: () => string;
    reportFormVrHeadsetOtherLabel?: () => string;
    reportFormVrHint?: () => string;
    reportFormNotePhrasesLabel?: () => string;
...
export const en: TranslationTree = {
  ...
  detail: {
    ...
    edit: 'Edit',
    upload: 'Submit',
    uploadDestinationTitle: 'Choose Submit Destination',
    uploadToProtonDB: 'Submit to ProtonDB',
  ...
  extras: {
    ...
    updateUpToDate: (channel, version) => `Up to date (latest ${channel}: ${version})`,
