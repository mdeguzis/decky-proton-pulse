...
| `src/components/tabs/GeneralSettingsTab.tsx` | 415 | string | Could not auto-restart. Restart Decky Loader or Steam manually. |
| `src/components/tabs/GeneralSettingsTab.tsx` | 870 | jsx | Update failed: |
| `src/components/tabs/GeneralSettingsTab.tsx` | 874 | jsx | Up to date (latest |
| `src/components/tabs/GeneralSettingsTab.tsx` | 874 | jsx | : v |
| `src/components/tabs/GeneralSettingsTab.tsx` | 879 | jsx | Update available: v |
